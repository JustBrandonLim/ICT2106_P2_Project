...
public class CommonSeedData
{
    public static async Task Seed(ApplicationDbContext context)
    {
        ...
        var devices = new List<Device>
        {
            ...
            new()
            {
                DeviceId = new Guid("44444444-4444-4444-4444-444444444444"),
            ...
            new()
            {
                DeviceId = new Guid("55555555-5555-5555-5555-555555555555"),
        ...
        var AmountOfNotificationsToBeSeeded = 20;
        for (var i = 0; i < AmountOfNotificationsToBeSeeded; i++)
        {
        ...
        var deviceProducts = new List<DeviceProduct>
        {
            new()
            {
                ...
                ProductQuantity = 100,
                ProductImageUrl =
                    "https://dynamic.zacdn.com/0D_IA2YBIJba0bZRGmDD2XKZDRc=/fit-in/346x500/filters:quality(95):fill(ffffff)/https://static-sg.zacdn.com/p/xiaomi-1178-9565502-1.jpg"
            }
        };
